...
class InstagramProvider(ProviderBase):
    """Instagram business profile provider. Not implemented yet."""

    source: ClassVar[ResearchSource] = ResearchSource.INSTAGRAM

    async def search(self, query: CompanySearchQuery) -> list[ResearchResult]:
        raise NotImplementedError("InstagramProvider.search() is not implemented yet.")

    async def get_company(self, identifier: str) -> ResearchResult | None:
        raise NotImplementedError("InstagramProvider.get_company() is not implemented yet.")

    async def search_contacts(self, company: ResearchResult) -> list[ContactLead]:
        raise NotImplementedError("InstagramProvider.search_contacts() is not implemented yet.")

    async def health_check(self) -> bool:
        raise NotImplementedError("InstagramProvider.health_check() is not implemented yet.")
