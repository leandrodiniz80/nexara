...
class LinkedInProvider(ProviderBase):
    """LinkedIn (companies + people) provider. Not implemented yet."""

    source: ClassVar[ResearchSource] = ResearchSource.LINKEDIN

    async def search(self, query: CompanySearchQuery) -> list[ResearchResult]:
        raise NotImplementedError("LinkedInProvider.search() is not implemented yet.")

    async def get_company(self, identifier: str) -> ResearchResult | None:
        raise NotImplementedError("LinkedInProvider.get_company() is not implemented yet.")

    async def search_contacts(self, company: ResearchResult) -> list[ContactLead]:
        raise NotImplementedError("LinkedInProvider.search_contacts() is not implemented yet.")

    async def health_check(self) -> bool:
        raise NotImplementedError("LinkedInProvider.health_check() is not implemented yet.")
